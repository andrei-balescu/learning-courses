...
public class AirVinylDbContext : DbContext
{
    ...
    public AirVinylDbContext(DbContextOptions<AirVinylDbContext> dbContextOptions) 
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        SeedRecordStore(modelBuilder);

        SeedRating(modelBuilder);
    }

    private void SeedPressingDetail(ModelBuilder modelBuilder)
    {
    ...
    private void SeedVinylRecord(ModelBuilder modelBuilder)
    {
    ...
    private void SeedRecordStore(ModelBuilder modelBuilder)
    {
    ...
    private void SeedRating (ModelBuilder modelBuilder)
    {
